...
// LifeInsuranceController operations for LifeInsurance
type LifeInsuranceController struct {
	beego.Controller
}

// URLMapping ...
func (c *LifeInsuranceController) URLMapping() {
...
// @router / [post]
func (c *LifeInsuranceController) Post() {
...
// @router /:id [get]
func (c *LifeInsuranceController) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *LifeInsuranceController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllLifeInsurance(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @router /:id [put]
func (c *LifeInsuranceController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *LifeInsuranceController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
