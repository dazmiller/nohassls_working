...
func init() {
	orm.RegisterModel(new(LifeInsurance), new(FuneralInsurances), new(HomeInsurances), new(MortgageInsurances), new(Providers), new(Products), new(QuoteMessages), new(QuoteContactRequests))
}
